...
class ReviveAdserverCachedContainer extends Container
{
    ...
    {
        return $this->services['filesystem'] = new \League\Flysystem\Filesystem(new \League\Flysystem\Adapter\Local('/var/www/html/revive/www/images', 0));
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'database.socket' => '',
            'database.port' => '3306',
            'database.username' => 'revive_adserver',
            'database.password' => 'Asd@2024',
            ...
            'webpath.admin' => '192.168.150.140/revive/www/admin',
            'webpath.delivery' => '192.168.150.140/revive/www/delivery',
            'webpath.deliverySSL' => '192.168.150.140/revive/www/delivery',
            'webpath.images' => '192.168.150.140/revive/www/images',
            'webpath.imagesSSL' => '192.168.150.140/revive/www/images',
            ...
            'file.xmlrest' => 'ax.php',
            'store.mode' => '0',
            'store.webDir' => '/var/www/html/revive/www/images',
            'store.ftpHost' => '',
            'store.ftpPath' => '',
            'store.ftpUsername' => '',
            'store.ftpPassword' => '',
            ...
            'delivery.secret' => 'MTgqTLrWZtdp9zEd0IwuW3XJEfkFAIonjnE4hCGZxcQ=',
            ...
            'email.qmailPatch' => '',
            'email.fromName' => '',
            'email.fromAddress' => 'francoryan22@gmail.com',
            'email.fromCompany' => '',
